...
if ($result->num_rows > 0) {
	...
	while($row = $result->fetch_assoc()) {
		...
		echo "&nbsp;&nbsp;&nbsp;";
		echo "<form action='../events/delete_event.php' method = 'post'>"."<button class='btn my-2 my-sm-0 buttonlc' style='outline: auto; outline-color: lightcoral;' type='submit' value = ' " . $row["event_id"]. "' name = 'event_id'>DELETE</button>" . " </form>" ;
		echo "</div>";
		echo "</div>";
		echo "</div>";
		echo "<hr>";
